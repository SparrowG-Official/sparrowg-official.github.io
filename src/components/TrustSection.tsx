  ...
  return <section className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-20 max-w-5xl mx-auto">
          ...
          return <Card key={index} variant="elevated" className="text-center hover-lift">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-6 lg:gap-10">
            {partners.map((partner, index) => <div key={index} className="flex flex-col items-center gap-2 opacity-60 hover:opacity-100 transition-opacity duration-300">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {caseStudies.map((study, index) => <Card key={index} variant="glass" className="hover-lift">
                <CardContent className="p-6 lg:p-8">
